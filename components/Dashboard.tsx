...
export const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setStats({
        todaySales: (todayBills as Bill[]).reduce((sum: number, b: Bill) => sum + b.total, 0),
        monthSales: (allBills as Bill[]).reduce((sum: number, b: Bill) => sum + b.total, 0), // Simplified for demo
        todayProfit: (todayBills as Bill[]).reduce((sum: number, b: Bill) => sum + b.totalProfit, 0),
        totalProfit: (allBills as Bill[]).reduce((sum: number, b: Bill) => sum + b.totalProfit, 0),
